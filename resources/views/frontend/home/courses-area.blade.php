@php
$courses = App\Models\Course::where('status',1)->orderBy('id','desc')->limit(6)->get();
...
<section class="course-area pb-120px">
    <div class="container">
        <div class="section-heading text-center">
            ...
            <h2 class="section__title">The world's largest selection of languages</h2>
            <span class="section-divider"></span>
        </div><!-- end section-heading -->

        <ul class="nav nav-tabs generic-tab justify-content-center pb-4"5 id="myTab" role="tablist">
            <li class="nav-item">
