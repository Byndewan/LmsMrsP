                ...
                <div class="about-content pb-5">
                    ...
                    <div class="row pt-4 pb-3">
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                <div class="icon-element icon-element-md shadow-sm">
                                    <svg class="svg-icon-color-5" width="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                <div class="icon-element icon-element-md shadow-sm">
                                    <svg class="svg-icon-color-7" width="35" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3">Live Chat</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                <div class="icon-element icon-element-md shadow-sm">
                                    <svg class="svg-icon-color-2" width="34" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
