                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" class="pt-4" action="{{ route('register') }}">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" id="email" name="email" placeholder="Enter email address">
                            ...
                            <div class="input-box">
                                ...
                                <div class="input-group mb-3">
                                    <span class="la la-lock input-icon"></span>
                                    <input class="form-control form--control" type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm Password">
