                ...
                <div class="course-details-content-wrap pt-90px">
                    ...
                    <div class="course-overview-card">
                        ...
                        <div class="collapse" id="collapseMore">
                            ...
                            <p class="fs-15 pb-2">{{ $course->prerequisite }}</p>
                        </div>
                            ...
                            <div class="preview-course-feature-content pt-40px">
                                ...
                                <div class="buy-course-btn-box">
                                    ...
                                    <div class="input-group mb-2" id="couponField">
                                        <input class="form-control form--control pl-3" type="text" id="coupon_name" name="search" placeholder="Coupon code">
                                        <div class="input-group-append">
                                            ...
                                            <a type="submit" onclick="applyInsCoupon()" class="btn theme-btn" style="color: #fff;">Apply Coupon</a>
                                        </div>
                                    </div>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item generic-list-item-flash">
                                ...
                                <li class="d-flex align-items-center justify-content-between"><span><i class="la la-bolt mr-2 text-color"></i>Course contentzes</span> 26</li>
            ...
            <div class="modal-body">
                <div class="copy-to-clipboard">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form--control copy-input pl-3" value="http://127.0.0.1:800/{{ Request::path() }}">
                        <div class="input-group-append">
