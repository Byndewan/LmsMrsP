        ...
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('update.course') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="selling_price" class="form-control" value="{{ $course->selling_price }}">
                </div>

                <div class="form-group col-md-3">
                    <label class="form-label">Discount Price</label>
                    <input type="text" name="discount_price" class="form-control" value="{{ $course->discount_price }}">
                </div>
                ...
                <div class="form-group col-md-12">
                    <label class="form-label">Course Prerequisite</label>
                    <textarea placeholder="Prerequisite ..." name="prerequisite" class="form-control" rows="3">{{ $course->prerequisite }}</textarea>
                </div>

                <div class="form-group col-md-12">
                    <label class="form-label">Course Description</label>
                    <textarea id="myeditorinstance" name="description" class="form-control">{!! $course->description !!}</textarea>
                </div>
